...
describe('Notification Service', () => {
  ...
  it('Verify notification scheduler runs daily', () => {
  ...
  it('Verify birthday reminder notification is sent to admin one month before employee birthday', async () => {
    // Дата "сегодня"
  ...
  it('Verify salary increase reminder notification is sent to admin one month before scheduled raise', async () => {
    const today = new Date();
  ...
  it('Verify admin receives notification after automatic salary increase', async () => {
    const today = new Date();
